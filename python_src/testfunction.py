...
def main(initflag):
    teststr="Enter_new_road nxt velocity 42.6 nxt road_id 5 nxt way_points : nxt 0 35.18413 128.0713 3.3 1 0 nxt 1 35.18413 128.0713 3.3 1 0 nxt 2 35.18513 128.0673 3.3 1 0 nxt 3 35.18603 128.0653 3.3 1 0 nxt 10 35.18413 128.0713 3.3 1 1"
    ...
    print("SEND DATA : ", teststr)
    car_data, drone_data = readmsg(teststr, car_data, drone_data)
    ...
    print("car velocity : ", car_data['velocity'], "\t",  "car waypoint : ", car_data['waypoint_id'])
    print("\n----------------------PRINT DRONE DATA----------------------\n")
    print(drone_data)
